...
ua = ["Mozilla/5.0 (Linux; Android 12; moto g(40) fusion Build/RRI31.Q1-42-51-12; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/96.0.4664.104 Mobile Safari/537.36",]
ugen2=[]
ugen=[]
cokbrut=[]
...
def Subscraption():
	key1=open('/storage/emulated/0/android12.txt', 'r').read()
